...
var TRANSLATIONS = {
  en: {
    ...
    chitMembers: 'Total Members',
    chitTenure: 'Tenure (Months)',
    chitForeman: 'Foreman Commission',
    chitPayout: 'Payout Rule',
    chitPayoutA: 'Only non-winners get dividend (standard)',
    chitPayoutB: 'Everyone except winner gets dividend',
    chitPayoutC: 'Winner exits after winning',
    chitPayoutD: 'Everyone gets dividend (incl. winner)',
    chitApplyDisc: 'Set all months to discount',
    chitApplyAmt: 'Discount Amount',
    chitApplyAll: 'Apply to all months',
    chitHint: 'Each month one member wins the auction and receives that month’s prize. The discount (chit value − prize) minus the foreman’s commission is shared as dividend among the eligible members. Enter a prize for every month below, then see each win position’s net savings.',
    ...
    chitNeverWinTitle: 'If You Never Win',
    chitTotalDiv: 'Total Dividend Received',
    chitNetOutcome: 'Net Outcome',
    chitShowCalc: 'How is the Effective Annual Return calculated?',
    chitNeverWin: 'If You Never Win',
    chitNeverWinNote: 'Without winning, your discounted installments are never returned as a lump sum — the return only comes from the dividend, and your capital funds the winners’ prizes.',
    chitSchedule: 'Month-wise Prizes (edit each month)',
    chitColMonth: 'Month',
    chitColInstall: 'Installment',
    chitColDiv: 'Dividend / Member',
    chitColNet: 'Net Outflow',
    chitColPrize: 'Prize (edit)',
    chitPrizeHint: 'Type a prize for any month. Use “Apply to all months” to set every month to one discount %. The dividend, payout summary and per-position table update live.',
    chitWinner: 'You win',
    chitAvgDiv: 'Avg Dividend / Member / Month',
    chitPosTitle: 'Per-position Payout (who wins each month)',
    chitPosMonth: 'Win Month',
    chitPosPrize: 'Prize Received',
    chitPosDiv: 'Dividend Earned',
    chitPosPaid: 'Total Paid',
    chitPosNet: 'Net Savings',
    chitPosRet: 'Effective Return',
    chitPosHint: 'Each row is a member who wins in that month and keeps paying installments for the full tenure (unless the payout rule says the winner exits). The final row is the last person.',
    chitLastTitle: 'Last Person (final month)',
    chitBestTitle: 'Best Position',
    chitWorstTitle: 'Worst Position',
    chitLastBreakdown: 'How is the last person’s outcome calculated?',
    ...
    chitFaqA2: 'When you win, you receive the prize amount (chit value minus the discount) early while you keep paying smaller, dividend-adjusted installments. The effective return annualises that cashflow into a comparable yearly rate (MIRR, assumed 6% p.a.).',
    chitFaqQ3: 'Why does the last person often do best?',
    chitFaqA3: 'Under the standard rule, members who haven’t won yet share each month’s dividend. The last winner has collected dividends in every earlier month and still receives a prize, so their net savings are usually the highest.',
  ...
  ta: {
    ...
    chitMembers: 'மொத்த உறுப்பினர்கள்',
    chitTenure: 'கால அவகாசம் (மாதங்கள்)',
    chitForeman: 'மேலாளர் கமிஷன்',
    chitDividend: 'சராசரி டிவிடெண்ட் / தள்ளுபடி',
    chitDiscountPct: 'தள்ளுபடி',
    chitWinMonth: 'நீங்கள் சிட்டை வெல்லும் மாதம்',
    chitHint: 'ஒவ்வொரு மாதமும் ஒரு உறுப்பினர் ஏலத்தில் வென்று அம்மாதப் பரிசைப் பெறுவார். தள்ளுபடி (சிட் மதிப்பு − பரிசு) மற்றும் மேலாளர் கமிஷனைக் கழித்தால் கிடைப்பது தகுதியுள்ள உறுப்பினர்களுக்கு டிவிடெண்டாகப் பகிரப்படும். ஒவ்வொரு மாதத்திற்கும் பரிசை உள்ளிட்டுப் பார்த்து, ஒவ்வொரு வெற்றி நிலையின் நிகர சேமிப்பைக் காணவும்.',
    ...
    chitNeverWinTitle: 'நீங்கள் ஒருபோதும் வெல்லவில்லை எனில்',
    chitTotalDiv: 'பெறப்பெற்ற மொத்த டிவிடெண்ட்',
    chitNetOutcome: 'நிகர முடிவு',
    chitShowCalc: 'பயனுள்ள ஆண்டு வருவாய் எவ்வாறு கணக்கிடப்படுகிறது?',
    chitNeverWinNote: 'வெல்லாவிட்டால், உங்கள் தள்ளுபடி செய்யப்பட்ட தவணைகள் ஒருமுறைத் தொகையாக திரும்ப வழங்கப்படாது — வருமானம் டிவிடெண்ட் மூலமே கிடைக்கும், மேலும் உங்கள் மூலதனம் வெற்றியாளர்களின் பரிசுகளுக்குப் பயன்படுத்தப்படும்.',
    chitSchedule: 'மாதவாரி பரிசுகள் (ஒவ்வொரு மாதமும் திருத்தவும்)',
    chitColMonth: 'மாதம்',
    chitColInstall: 'தவணை',
    chitColDiv: 'டிவிடெண்ட் / உறுப்பினர்',
    chitColNet: 'நிகர வெளிப்போக்கு',
    chitColPrize: 'பரிசு (திருத்தவும்)',
    chitPrizeHint: 'ஏதாவது மாதத்திற்குப் பரிசுத் தொகையை உள்ளிடவும். “அனைத்து மாதங்களுக்கும் பொருந்தும்” மூலம் ஒரே தள்ளுபடியை அனைத்து மாதங்களுக்கும் அமைக்கலாம். டிவிடெண்ட், விநியோகச் சுருக்கம் மற்றும் பதவி வாரியான அட்டவணை நேரடியாகப் புதுப்படும்.',
    chitWinner: 'நீங்கள் வெற்றி',
    chitPayout: 'விநியோக விதி',
    chitPayoutA: 'வெற்றி பெறாதவர்களுக்கு மட்டுமே டிவிடெண்ட் (நிலையான)',
    chitPayoutB: 'வெற்றியாளரைத் தவிர அனைவருக்கும் டிவிடெண்ட்',
    chitPayoutC: 'வெற்றி பெற்றவர் வென்ற பிறகு வெளியேறுவார்',
    chitPayoutD: 'அனைவருக்கும் டிவிடெண்ட் (வெற்றியாளர் உட்பட)',
    chitApplyDisc: 'அனைத்து மாதங்களையும் தள்ளுபடிக்கு அமை',
    chitApplyAmt: 'தள்ளுபடித் தொகை',
    chitApplyAll: 'அனைத்து மாதங்களுக்கும் பொருந்தும்',
    chitAvgDiv: 'உறுப்பினர் / மாதம் சராசரி டிவிடெண்ட்',
    chitPosTitle: 'பதவி வாரியான விநியோகம் (யார் எந்த மாதம் வெல்கிறார்கள்)',
    chitPosMonth: 'வெற்றி மாதம்',
    chitPosPrize: 'பெறப்பட்ட பரிசு',
    chitPosDiv: 'சம்பாதித்த டிவிடெண்ட்',
    chitPosPaid: 'செலுத்திய மொத்தம்',
    chitPosNet: 'நிகர சேமிப்பு',
    chitPosRet: 'நிகர வருவாய்',
    chitPosHint: 'ஒவ்வொரு வரிசையும் அந்த மாதம் வெல்லும் உறுப்பினரைக் குறிக்கிறது; விநியோக விதி வெற்றியாளர் வெளியேறுவதாகக் கூறாவிட்டால் முழு காலத்திற்கும் தவணை செலுத்துவார். கடைசி வரிசை கடைசி நபர்.',
    chitLastTitle: 'கடைசி நபர் (இறுதி மாதம்)',
    chitBestTitle: 'சிறந்த நிலை',
    chitWorstTitle: 'மோசமான நிலை',
    chitLastBreakdown: 'கடைசி நபரின் முடிவு எவ்வாறு கணக்கிடப்படுகிறது?',
    ...
    chitFaqA2: 'நீங்கள் வென்றால், பரிசுத் தொகை (சிட் மதிப்பிலிருந்து தள்ளுபடி கழித்தது) முன்கூட்டியே கிடைக்கும், அதே சமயம் நீங்கள் சிறிய, டிவிடெண்ட் சரிசெய்யப்பட்ட தவணைகளைத் தொடர்ந்து செலுத்துவீர்கள். நிகர வருவாய் அந்தப் பணப்புழக்கை ஒப்பிடத்தக்க ஆண்டு விகிதமாக மாற்றுகிறது (MIRR, 6% ஆண்டுக்கு எனக் கொள்ளப்பட்டது).',
    chitFaqQ3: 'கடைசி நபர் பெரும்பாலும் சிறப்பாக ஏன் முடிகிறார்?',
    chitFaqA3: 'நிலையான விதியின் கீழ், இதுவரை வெல்லாத உறுப்பினர்கள் ஒவ்வொரு மாதத்தின் டிவிடெண்டைப் பகிர்ந்து கொள்கிறார்கள். கடைசி வெற்றியாளர் முந்தைய அனைத்து மாதங்களிலும் டிவிடெண்டைப் பெற்றிருப்பார் மற்றும் ஒரு பரிசையும் பெறுவார், எனவே அவரது நிகர சேமிப்பு பொதுவாக மிக உயர்ந்ததாக இருக்கும்.',
